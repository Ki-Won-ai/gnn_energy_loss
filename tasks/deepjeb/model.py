"""
Lightning Module for DeepJEB task.
...
class DeepJEBLitModel(L.LightningModule):
    """
    PyTorch Lightning module for DeepJEB stress prediction task.
